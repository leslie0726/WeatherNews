...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { dataCreationDate: @weather.dataCreationDate, siteName: @weather.siteName, temperature: @weather.temperature, weather: @weather.weather, windDirection: @weather.windDirection, windPower: @weather.windPower } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { dataCreationDate: @weather.dataCreationDate, siteName: @weather.siteName, temperature: @weather.temperature, weather: @weather.weather, windDirection: @weather.windDirection, windPower: @weather.windPower } }
